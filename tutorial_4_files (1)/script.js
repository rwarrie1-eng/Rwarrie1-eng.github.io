...
regret.textContent = `Ugh you are missing the event of the century, ${getName()}. Your loss!`;
...
if (isGoing) {
  ...
  regret.textContent = `${getName()} Ugh you are missing the event of the century, Your loss!`;  
  }
});
