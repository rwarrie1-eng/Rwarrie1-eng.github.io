...
document.addEventListener('DOMContentLoaded', function() {
    ...
    loadButton.addEventListener('click', async function() {
        ...
        try {
            ...
            statusMessage.textContent = `Loaded ${restaurants.length} restaurants!`;
    ...
    errorButton.addEventListener('click', async function() {
        ...
        try {
            ...
            // YOUR CODE HERE:
            errorDisplay.innerHTML = '<div class="error-message"> Oops! Could not load data. The file does not exist. </div>';
